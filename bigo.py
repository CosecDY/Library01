...
#มีส่วนสำคัญคือ constructorและ Method to_json ซึ่งเป็นส่วนที่คำนวณ Big O notation ของโค้ดนี้
#ในconstructor __init__, มีการกำหนดค่าให้กับคุณสมบัติต่าง ๆ ของObject Book โดยมีบรรทัดที่ใช้ self.bookId = Book.nextBookId และ Book.nextBookId += 1 ซึ่งทำให้ค่า nextBookId เพิ่มขึ้นทุกครั้งที่สร้างอ็อบเจ็กต์ใหม่. ซึ่งนี้จะมีความซับซ้อน O(1)หรือคงที่เท่านั้น เนื่องจากจำนวนขั้นตอนที่ทำงานไม่ขึ้นอยู่กับขนาดข้อมูลขาเข้า.
#Method to_json ทำงานโดยสร้างObject JSON และกำหนดค่าให้กับคุณสมบัติต่างๆ ของObject Book. การทำงานนี้จะมีความซับซ้อน O(1) เช่นกัน เนื่องจากจำนวนขั้นตอนไม่ขึ้นอยู่กับขนาดข้อมูลขาเข้า.
#ดังนั้น โค้ดจะมี Big O notation ทั้งหมดเท่ากับ O(1) หรือ O(คงที่) เนื่องจากจำนวนขั้นตอนไม่ขึ้นอยู่กับขนาดข้อมูลขาเข้าในทั้ง ConstructorและMethod to_json.
...
class TreeNode:
    def __init__(self, data):
        ...
        self.left = None
        self.right = None
#มีConstructor __init__ สำหรับคลาส TreeNode ที่มีการกำหนดค่าให้กับคุณสมบัติ data, left, และ right ของObject TreeNode.
